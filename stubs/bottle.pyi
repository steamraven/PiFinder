...
Return = str | dict[str, str] | bytes
P = ParamSpec("P")
A = TypeVar("A")
OFunc = Callable[[], Return]
DFunc = Callable[[], Return]
Decorator = Callable[[OFunc], DFunc]
...
class Bottle:
    ...
    def route(self, path: str | None = ..., method: str = ..., callback: Incomplete | None = ..., name: Incomplete | None = ..., apply: Incomplete | None = ..., skip: Incomplete | None = ...) -> Decorator: ...
...
def load_app(target): ...
def run(app: Bottle | None = ..., server: str = ..., host: str = ..., port: int = ..., interval: int = ..., reloader: bool = ..., quiet: bool = ..., debug: bool | None = ...) -> NoReturn: ...
...
def template(template: str, *args: Any, **kwargs: Any) -> str: ...
